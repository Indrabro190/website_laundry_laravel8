            ...
            <form method="POST" enctype="multipart/form-data" action="/cabang/store">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="namecabang" placeholder="Nama Cabang...">
                </div>
              </div>
      ...
      <div class="modal fade" id="modalEditUser<?php echo e($d->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data" action="/cabang/<?php echo e($d->id); ?>/update">
              <?php echo csrf_field(); ?>
              <div class="modal-body">
                <input type="hidden" value="<?php echo e($d->id); ?>" name="id" required>
                <div class="form-group">
                  <label>Nama Cabang</label>
                  <input type="text" value="<?php echo e($d->namecabang); ?>" class="form-control" name="namecabang">
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn-btn-secondary" data-dismiss="modal"><i class="fa-solid fa-backward-step"></i>Close</button>
      ...
      <div class="modal fade" id="modalHapusUser<?php echo e($t->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="GET" enctype="multipart/form-data" action="/cabang/<?php echo e($t->id); ?>/destroy">
              <?php echo csrf_field(); ?>
              <div class="modal-body">
...
</html><?php /**PATH D:\laravel\laundry\resources\views/admin/master/cabang/datacabang.blade.php ENDPATH**/ ?>