                                ...
                                <form method="POST" enctype="multipart/form-data" action="#">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="<?php echo e(Auth::user()->level); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
...
</html><?php /**PATH D:\laravel\laundry\resources\views/dataprofile.blade.php ENDPATH**/ ?>