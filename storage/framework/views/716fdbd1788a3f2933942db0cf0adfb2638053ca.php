    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e($paket); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e($total_bayar); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <script type="text/javascript">
          var Pendapatan = <?php echo json_encode($total_bayar) ?>;
        ...
        <script type="text/javascript">
          var Pendapatan = <?php echo json_encode($total_bayar1) ?>;
...
<?php /**PATH D:\laravel\laundry\resources\views/dashboard.blade.php ENDPATH**/ ?>