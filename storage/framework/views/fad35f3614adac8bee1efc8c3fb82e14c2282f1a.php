<aside class="main-sidebar sidebar-dark-success elevation-4">
  ...
  <a href="/laundry" class="brand-link" style="background-color: #565656;">
    <img src="<?php echo e(asset('dist/img/laundry.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?php echo e(asset('dist/img/laundry2.png')); ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <a href="/laundry" class="d-block"><?php echo e(Auth::user()->name); ?></a>
      </div>
    </div>
  ...
  <!-- /.sidebar -->
</aside><?php /**PATH D:\laravel\laundry\resources\views/Template/sidebar.blade.php ENDPATH**/ ?>